                                            ...
                                            <select class="form-control" onchange="this.form.submit()" name="division">
                                                ...
                                                @foreach ($divisions as $division)
                                                    <option value="{{ $division->id }}"
                                                        {{ $division->id == @$_GET['division'] ? 'selected' : '' }}>
                                ...
                                <div class="search-element">
                                    <form action="/users" method="GET">
                                        <input class="form-control selectric" type="search" placeholder="Search"
                                            aria-label="Search" name="search" value="{{ @Request()->search }}" id="search">
                                    </form>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('division') is-invalid @enderror" id="division"
                                ...
                                @foreach ($divisions as $division)
                                    <option value="{{ $division->id }}"
                                        {{ old('division') == $division->id ? 'selected' : '' }}>{{ $division->name }}
                                    </option>
                                @endforeach>
                            </select>
                            @error('division')
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nameEdit') is-invalid @enderror"
                                id="nameEdit" name="nameEdit" value="{{ old('nameEdit') }}" required>
                            @error('nameEdit')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
