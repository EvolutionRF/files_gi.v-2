            ...
            <div class="row sortable-card">
                @foreach ($baseFolders as $baseFolder)
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <a href="#!" class="card" data-toggle="modal" data-target=".show-modal"
                            data-title="Detail Folder" data-url="{{ route('basefolder.show', $baseFolder->id) }}">
                            <div class="card-body">
                                <h6>{{ $baseFolder->name }}</h6>
                            </div>
                        </a>
                                        ...
                                        <ul class="navbar-nav">
                                            <li class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right ml-0">
                                                    ...
                                                    <a type="button" class="dropdown-item has-icon pl-2"
                                                        data-toggle="modal" data-target="#manageFolder"
                                                    ...
                                                    <a type="button" class="dropdown-item has-icon pl-2"
                                                        data-toggle="modal" data-target="#DeleteBaseFolder"
            ...
            <div class="modal-content">
                ...
                <form action="" method="Post" id="FormrenameBaseFolder">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <h6>File Title</h6>
                            <input type="text" class="form-control" name="NameRenameBaseFolder"
                                id="NameRenameBaseFolder">
                        </div>
                    </div>
